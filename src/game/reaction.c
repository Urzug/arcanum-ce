...
// 0x4C1020
void ai_enter_dialog(int64_t npc_obj, int64_t pc_obj)
{
    int v1;
...
// 0x4C10A0
void ai_exit_dialog(int64_t npc_obj, int64_t pc_obj)
{
    int v1;
...
{
    obj_arrayfield_handle_set(npc_obj, OBJ_F_NPC_REACTION_PC_IDX, index, pc_obj);
