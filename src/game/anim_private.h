...
extern int g_anim_current_run_index;
extern int g_animGoalParamTypes[AGDATA_COUNT];
extern bool g_anim_interrupt_priority_3_flag;
extern void (*g_anim_completion_callback)();
extern bool in_anim_load;
extern int g_anim_system_active;
extern int animNumActiveGoals;
extern int g_anim_save_version;
extern int g_anim_unknown_739E40;
extern int g_anim_unknown_739E44;
...
bool AnimGoalDataInit(AnimGoalData* goal_data, int64_t obj, int goal_type);
bool AnimGoalDataInitNoPriority(AnimGoalData* goal_data, int64_t obj, int goal_type);
bool StartAnimationGoal(AnimGoalData* goal_data, AnimID* anim_id);
bool AnimGoalStartEx(AnimGoalData* goal_data, AnimID* anim_id, unsigned int flags);
...
bool InterruptAnimsByType(int64_t a1, int a2, int a3);
...
bool FindAnimationByGoalType(int64_t a1, AnimID* anim_id, int64_t a2);
